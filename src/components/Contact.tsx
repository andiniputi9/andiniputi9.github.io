...
import { Mail, Phone, Linkedin, MapPin, Send, MessageCircle, Sparkles, ArrowRight } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            I'm always open to discussing Quality Assurance opportunities, 
            sharing knowledge, or collaborating on exciting projects.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="bg-white/60 backdrop-blur-xl rounded-3xl shadow-xl p-8 border border-white/20 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-6 py-4 border border-gray-200/50 rounded-2xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-300 bg-white/50 backdrop-blur-sm font-medium"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows={6}
                  className="w-full px-6 py-4 border border-gray-200/50 rounded-2xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-300 resize-none bg-white/50 backdrop-blur-sm font-medium"
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white py-4 px-8 rounded-2xl hover:from-indigo-700 hover:via-purple-700 hover:to-pink-700 transition-all duration-300 font-bold flex items-center justify-center gap-3 shadow-lg hover:shadow-xl hover:-translate-y-1 group"
              >
                <Send size={20} />
                Send Message
